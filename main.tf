...
resource "local_file" "ansible_inventory" {
  ...
  content = <<EOT
[attack_range]
${aws_instance.attack_range.public_ip} ansible_user=ubuntu ansible_ssh_private_key_file="/home/ubuntu/keys/Attack_range.pem" ansible_ssh_common_args='-o StrictHostKeyChecking=no'
EOT
}
